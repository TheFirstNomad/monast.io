...
import { MapPin, Star, MessageCircle, DollarSign, Shield, ChevronLeft, ChevronRight, Share2, Heart } from "lucide-react";
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <div className="bg-card rounded-xl border border-border p-5">
              ...
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <div className="font-medium text-foreground text-sm">{ad.seller.name}</div>
                  <div className="flex items-center gap-1 text-xs text-muted-foreground">
                    <Star className="w-3 h-3 fill-primary text-primary" />
                    {ad.seller.rating} · {ad.seller.totalAds} ads
                  </div>
                </div>
              </div>
              <div className="text-xs text-muted-foreground">
                Member since {new Date(ad.seller.joinedDate).toLocaleDateString("en-US", { month: "long", year: "numeric" })}
              </div>
            </div>
          </div>
        </div>
